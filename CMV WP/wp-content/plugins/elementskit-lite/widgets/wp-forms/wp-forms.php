...
class Elementskit_Widget_Wp_Forms extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            'ekit_wpForms_input_height',
            [
                'label'             => __( 'Input Height', 'elementskit' ),
                'type'              => Controls_Manager::SLIDER,
                'range'             => [
                    'px' => [
                        'min'   => 0,
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .ekit_wpForms_container .wpforms-field input:not([type=radio]):not([type=checkbox]):not([type=submit]):not([type=button]):not([type=image]):not([type=file]), {{WRAPPER}} .ekit_wpForms_container .wpforms-field select' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
